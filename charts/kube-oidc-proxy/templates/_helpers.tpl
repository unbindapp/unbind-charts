...
{{ include "kube-oidc-proxy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kube-oidc-proxy.selectorLabels" -}}
...
*/}}
{{- define "kube-oidc-proxy.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kube-oidc-proxy.fullname" .) .Values.serviceAccount.name }}
{{- else }}
